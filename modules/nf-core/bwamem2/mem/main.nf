// Copied verbatim from https://github.com/nf-core/modules (nf-core/bwamem2/mem)
// Container: community.wave.seqera.io (bwa-mem2 + samtools, no mixed tools per process)
